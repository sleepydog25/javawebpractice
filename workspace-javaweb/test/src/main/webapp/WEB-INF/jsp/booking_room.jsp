...
<body style="padding: 15px">
	<!-- 新增Booking Room -->
	<form class="pure-form" action="/test/bookingroom" method="post">
		<fieldset>
		...
		<tbody>
			<c:forEach items="${bookingRoomDtos}" var="bookingRoomDto">
				<tr>
					...
					<td>
							<a href="/test/bookingroom/update?roomId=${bookingRoomDto.bookingId}" class="pure-button">編輯</a>
					</td>
					<td>
						<a href="/test/bookingroom?deleteId=${bookingRoomDto.bookingId}" class="pure-button">刪除</a>
					</td>
