...
<html>
	...
	<body style="padding: 15px">
		<!-- 新增Room -->
		<form class="pure-form" action="/test/room" method="post">
			<fieldset>
			...
			<tbody>
				<c:forEach items="${rooms}" var="room">
					<tr>
						...
						<td>${room.roomName}</td>
						<td>
							<a href="/test/room/update?roomId=${room.roomId}" class="pure-button">編輯</a>
						</td>
						<td>
							<a href="/test/room?deleteId=${room.roomId}" class="pure-button">刪除</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
