...
public class TestHelloAndLotto {
	public static void main(String[] args) {
		...
		//ApplicationContext ctx = new AnnotationConfigApplicationContext(session01.config.SpringJavaConfig.class);
		//ApplicationContext ctx = new AnnotationConfigApplicationContext(session01.config.SpringJavaConfig2.class);
